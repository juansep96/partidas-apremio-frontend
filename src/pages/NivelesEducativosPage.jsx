...
import { nivelesEducativosApi, dsApi } from '../api/client';
...
export default function NivelesEducativosPage({ desarrolloSocial = false }) {
  ...
  const api = desarrolloSocial ? dsApi.nivelesEducativos : nivelesEducativosApi;
  ...
  const loadNiveles = useCallback(async () => {
    ...
    try {
      ...
      sileo.error({ title: 'Error al cargar niveles educativos', description: err.message });
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (modal === 'create') {
        ...
        sileo.success({ title: 'Nivel educativo creado' });
      } else {
        await api.update(modal.id, payload);
        sileo.success({ title: 'Nivel educativo actualizado' });
      }
      closeModal();
      loadNiveles();
    } catch (err) {
      ...
      <div className="admin-page calles-page">
        <header className="admin-hero">
          <div>
            ...
            <p>Gestión de niveles educativos (Primario, Secundario, Terciario, Universitario)</p>
          </div>
        ...
        <div className="admin-content">
          {loading ? (
            <div className="admin-loading-state">
              ...
              <p>Cargando niveles educativos...</p>
            </div>
          ) : niveles.length === 0 ? (
            <div className="admin-empty-state">
              <p>No hay niveles educativos.</p>
            </div>
          ) : (
            ...
            <div className="calles-pagination">
              <div className="calles-pagination-nav">
                ...
                <span className="calles-pagination-info">
                  Pág. {meta.current_page} de {meta.last_page} ({meta.total} niveles)
                </span>
                <button
                  type="button"
                  className="calles-pagination-btn"
          ...
          <div className="admin-modal-overlay" onClick={closeModal}>
            ...
            >
              <header className="admin-modal-header">
                <h2>{modal === 'create' ? 'Nuevo nivel educativo' : 'Editar nivel educativo'}</h2>
                ...
                <section className="admin-form-section">
                  <div className="admin-field">
                    ...
                    <input
                      ...
                      placeholder="Ej: Primario Completo"
                      required
                    />
                  </div>
                </section>
